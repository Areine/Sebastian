...
public class StartScreen implements Screen {
	...
	public void display() {
		...
		System.out.println("Hit enter again to release the first ball");
		System.out.println("Hit enter again to release the second ball");
		System.out.println("Hit enter again to release the third ball");
		infoBox.display();
	}
